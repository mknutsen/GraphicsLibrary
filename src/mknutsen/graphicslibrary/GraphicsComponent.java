...
/**
 * GraphicsComponent sets forth the basic requirements of a JPanel to
 * communicate properly with the graphics driver.
 * 
...
public abstract class GraphicsComponent extends JPanel {
	...
	/**
	 * Necessary to equip the component with the ability to trigger component
	 * switching
	 * 
	 * @param callback
	 *            callback to execute
